it('does not re-render parent child components', async () => {
  ...
  expect(input1RenderCount).toBe(expectedInput1RenderCounts[0])
  ...
  expect(input1RenderCount).toBe(expectedInput1RenderCounts[1])
  ...
  // Both `Input1`'s are re-rendered (See: https://github.com/vuejs/vue/issues/7257)
  expect(input1RenderCount).toBe(expectedInput1RenderCounts[2])
