it('renders with correct basic inner structure', async () => {
  ...
  const assertNonActiveDisabledItem = li => {
  ...
  const assertActiveEnabledItem = li => {
    expect(li.classes()).toContain('page-item')
  ...
  assertNonActiveDisabledItem(first)
  assertNonActiveDisabledItem(prev)
  assertActiveEnabledItem(page)
  assertNonActiveDisabledItem(next)
  assertNonActiveDisabledItem(last)
