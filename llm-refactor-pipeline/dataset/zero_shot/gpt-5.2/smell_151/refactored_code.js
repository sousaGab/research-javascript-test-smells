it('renders with correct basic inner structure', async () => {
  ...
  expectDisabledItem(first)
  expectDisabledItem(prev)
  expectActiveItem(page)
  expectDisabledItem(next)
  expectDisabledItem(last)
