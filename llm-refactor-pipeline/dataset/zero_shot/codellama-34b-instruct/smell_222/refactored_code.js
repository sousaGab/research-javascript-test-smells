it('renders classes bv-d-xs-down-none when more than 3 pages', async () => {
  ...
  it('should have the last 4 page buttons with the display classes when currentPage = 0', async () => {
    const wrapper = mount(BPagination, {
      propsData: {
        totalRows: 70,
        perPage: 10,
  ...
  it('should have the first and last 2 pages buttons with the display classes when currentPage = 4', async () => {
    const wrapper = mount(BPagination, {
      propsData: {
        totalRows: 70,
        perPage: 10,
  ...
  it('should have the first 4 pages buttons with the display classes when currentPage = 4', async () => {
    const wrapper = mount(BPagination, {
      propsData: {
        totalRows: 70,
        perPage: 10,
