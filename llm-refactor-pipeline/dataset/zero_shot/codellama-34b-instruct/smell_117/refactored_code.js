...
function setCookies(cookies) {
  ...
  for (const cookie of cookies) {
    const cookieHeader = `${cookie.name}=${cookie.value}; Max-Age=${cookie.maxAge}; Domain=${cookie.domain}; Path=${cookie.path}; Expires=${cookie.expires.toUTCString()}; HttpOnly; Secure; SameSite=${cookie.sameSite}`
