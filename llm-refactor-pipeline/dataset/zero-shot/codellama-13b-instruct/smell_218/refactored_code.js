it('has prev/next controls when prop controls is set', async () => {
    ...
    expect($prev.attributes('aria-controls')).toEqual(`${wrapper.attributes('id')}___BV_inner_`)
    expect($next.attributes('aria-controls')).toEqual(`${wrapper.attributes('id')}___BV_inner_`)
