describe('default levels', function () {
  it('should have the correct highest log level', function () {
  ...
  it('should have the correct level enabled', function () {
    let logger = winston.createLogger({
      level: 'verbose',
      levels: winston.config.npm.levels,
      transports: [new winston.transports.Console()]
  ...
  it('should have the correct level enabled for each level', function () {
    let logger = winston.createLogger({
      level: 'verbose',
      levels: winston.config.npm.levels,
      transports: [new winston.transports.Console()]
