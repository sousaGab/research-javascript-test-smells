it("produces similar or better compaction height", () => {
      ...
      const ALLOWED_WORSE_CASE_PERCENTAGE = 0.8; // 80%
      const MAX_WORSE_CASES = NUMBER_OF_RUNS * ALLOWED_WORSE_CASE_PERCENTAGE;
      ...
      expect(stdBetter).toBeLessThan(MAX_WORSE_CASES); // At most 80% worse
    })