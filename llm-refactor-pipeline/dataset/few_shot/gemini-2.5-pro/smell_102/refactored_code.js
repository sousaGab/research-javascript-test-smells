describe('oneYearAgo', () => {
  it('should return the same calendar date from the previous year for a standard day', () => {
  ...
  it('should return Feb 28 of the previous year for Feb 29 of a leap year', () => {
