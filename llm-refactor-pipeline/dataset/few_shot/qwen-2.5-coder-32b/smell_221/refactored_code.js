it('works with $router to detect path and use-router set and linkGen returns string', async () => {
  ...
  const updatedPaginationNav = wrapper.findComponent(BPaginationNav)
  expect(updatedPaginationNav.exists()).toBe(true)
  expect(updatedPaginationNav.vm.currentPage).toBe(3)
