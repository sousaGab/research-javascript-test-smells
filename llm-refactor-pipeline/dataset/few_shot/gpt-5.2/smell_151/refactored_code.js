it('renders with correct basic inner structure', async () => {
  ...
  assertDisabledItem(lis.at(0))
  assertDisabledItem(lis.at(1))
  assertActiveItem(lis.at(2))
  assertDisabledItem(lis.at(3))
  assertDisabledItem(lis.at(4))
