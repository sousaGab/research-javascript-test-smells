test('set-cookie', async () => {
  ...
  const expectedResponseFor = (sourceName) => {
    ...
    if (sourceName === 'azureHttpFunctionV4' || sourceName === 'azureHttpFunctionV3') {
      return {
        ...base,
        cookies: [
          {
  ...
  expect(response).toEqual(expectedResponseFor(eventSourceName))
})