it('should populate the value attribute on select multiple using groups', () => {
    ...
    const fooHTML = '<option value="foo"></option>';
    const barHTML = '<option value="bar"></option>';
    ...
    expect(container.firstChild.childNodes[0].innerHTML).toEqual(fooHTML);
    expect(container.firstChild.childNodes[1].innerHTML).toEqual(barHTML);
