test.each([
  ...
  ["Mon, 02 Jan 2017 06:00:00 -0800", [2017, 1, 2, 14, 0, 0]],
  ...
  ["Mon, 02 Jan 2017 06:00:00 PST", [2017, 1, 2, 14, 0, 0]],
  ["Mon, 02 Jan 2017 06:00:00 PDT", [2017, 1, 2, 13, 0, 0]]
])("DateTime.fromRFC2822 parses '%s' correctly", (testString, expected) => {
  const result = DateTime.fromRFC2822(testString).toUTC();
  const actual = [result.year, result.month, result.day, result.hour, result.minute, result.second];
