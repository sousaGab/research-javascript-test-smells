test('set-cookie', async () => {
  ...
  const nonAzureExpectedResponse = makeResponse({
  ...
  const azureExpectedResponse = makeResponse({
    ...baseExpectedResponse,
    cookies: azureCookies,
    multiValueHeaders: commonHeaders
  })

  const expectedResponse =
    eventSourceName === 'azureHttpFunctionV4' || eventSourceName === 'azureHttpFunctionV3'
      ? azureExpectedResponse
      : nonAzureExpectedResponse
