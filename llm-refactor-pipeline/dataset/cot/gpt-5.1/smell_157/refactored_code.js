it('does not re-render parent child components', async () => {
  ...
  const expectedInput1RenderCountAfterFirstEnable = isVue3 ? 2 : 4
  const expectedInput1RenderCountAfterSecondEnable = isVue3 ? 2 : 6
  ...
  expect(input1RenderCount).toBe(expectedInput1RenderCountAfterFirstEnable)
  ...
  // Both `Input1`'s are re-rendered (See: https://github.com/vuejs/vue/issues/7257)
  expect(input1RenderCount).toBe(expectedInput1RenderCountAfterSecondEnable)
