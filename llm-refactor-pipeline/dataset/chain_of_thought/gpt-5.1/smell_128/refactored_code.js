it('should set, read and delete data with collisions', () => {
  ...
  const expectBucketStrings = (expectedStrings) => {
    expectedStrings.forEach(([bucketIndex, expected]) => {
      expect(hashTable.buckets[bucketIndex].toString(stringifier)).toBe(expected);
    });
  };
