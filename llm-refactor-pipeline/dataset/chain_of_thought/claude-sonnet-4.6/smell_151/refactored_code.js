it('renders with correct basic inner structure', async () => {
    ...
    // All items have page-item class
    ...
    // Active page (index 2) is active and not disabled, uses BUTTON
    ...
    // Non-active pages are not active, are disabled, use SPAN
