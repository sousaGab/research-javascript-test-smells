describe('datesEqual', () => {
  ...
  it('should return true for two Date objects representing the same date but different times', () => {
  ...
  it('should return false for a Date object and a date string representing different dates', () => {
